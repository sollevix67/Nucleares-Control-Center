...
for i in range(3):
    READABLE += [
        ...
        f"STEAM_TURBINE_{i}_RPM", f"STEAM_TURBINE_{i}_INSTALLED", f"STEAM_GEN_{i}_OUTLET",
...
class Plant:
    def __init__(self, chemistry_enabled: bool = False) -> None:
        ...
        self.values: dict[str, Any] = {
            ...
            "EMERGENCY_GENERATOR_1_MODE": "AUTO", "EMERGENCY_GENERATOR_1_STATUS": "STANDBY",
            "EMERGENCY_GENERATOR_1_PRESSURIZER": "OK", "EMERGENCY_GENERATOR_1_FUEL": 82.0,
            "EMERGENCY_GENERATOR_1_MAINTENANCE_NEEDED": False,
            "EMERGENCY_GENERATOR_2_MODE": "AUTO", "EMERGENCY_GENERATOR_2_STATUS": "STANDBY",
            "EMERGENCY_GENERATOR_2_PRESSURIZER": "OK", "EMERGENCY_GENERATOR_2_FUEL": 76.0,
